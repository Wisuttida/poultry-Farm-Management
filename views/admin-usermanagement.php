...
$content = function () use ($users) {
    if (isset($users) && !empty($users)) {
        ...
        <div class="container-fluid">
            <h1 class="h3 mb-2 mt-4 text-gray-800">การจัดการบัญชีผู้ใช้งาน</h1>
            ...
            บัญชีผู้ใช้งานทั้งหมด
                    ...
                    <form class="user" action="../controllers/user_store.php" method="POST" id="registerForm"
                        onsubmit="return validateForm()" style="font-size: 15px;"></form>
                    <a href="../views/admin-adduser.php" class="btn btn-primary btn-user btn-sm">สร้างบัญชีผู้ใช้</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                        ...
                                        <td>
                                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                                ...
                                                <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editUserModal<?php echo $user['userId']; ?>">
                                    ...
                                    <!-- Edit User Modal -->
                                    <form id="editAccountForm<?php echo $user['userId']; ?>" action="../controllers/update.php"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                                <div class="modal-content">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col d-flex flex-column align-items-center">
                                                                    <img class="img-profile rounded-circle mb-3" width="139"
                                                                        src="../public/img/login1.png" />
                                                                    <div class="mb-3 w-100">
                                                                        <label for="line<?php echo $user['userId']; ?>"
                                                                            class="form-label">Line</label>
                                                                        <input type="text" class="form-control"
                                                                            id="line<?php echo $user['userId']; ?>" name="line"
                                                                            value="<?php echo $user['lineId']; ?>" required />
                                                                        <div class="invalid-feedback">โปรดกรอก Line</div>
                                                                    </div>

                                                                    <div class="mb-3 w-100">
                                                                        <label for="gmail<?php echo $user['userId']; ?>"
                                                                            class="form-label">Gmail</label>
                                                                        <input type="email" class="form-control"
                                                                            id="gmail<?php echo $user['userId']; ?>" name="gmail"
                                                                            value="<?php echo $user['gmail']; ?>" required />
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="firstname<?php echo $user['userId']; ?>"
                                                                            class="form-label">ชื่อ</label>
                                                                        <input type="text" class="form-control"
                                                                            id="firstname<?php echo $user['userId']; ?>"
                                                                            name="fName" value="<?php echo $user['fName']; ?>"
                                                                            required />
                                                                        <div class="invalid-feedback">โปรดกรอกชื่อ</div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="lastname<?php echo $user['userId']; ?>"
                                                                            class="form-label">นามสกุล</label>
                                                                        <input type="text" class="form-control"
                                                                            id="lastname<?php echo $user['userId']; ?>" name="lName"
                                                                            value="<?php echo $user['lName']; ?>" required />
                                                                        <div class="invalid-feedback">โปรดกรอกนามสกุล</div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="username<?php echo $user['userId']; ?>"
                                                                            class="form-label">ชื่อบัญชีผู้ใช้</label>
                                                                        <input type="text" class="form-control"
                                                                            id="username<?php echo $user['userId']; ?>"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="role<?php echo $user['userId']; ?>"
                                                                            class="form-label">ตำแหน่ง</label>
                                                                        <select name="position" class="form-control"
                                                                            id="role<?php echo $user['userId']; ?>" required>
                                                                            ...
                                                                            <option value="คนงาน" <?php echo ($user['position'] == 'คนงาน') ? 'selected' : ''; ?>>
                                                                                คนงาน</option>
                                                                        </select>
                                                                    ...
                                                                    <div class="d-grid gap-2 w-100 mb-3">
                                                                        <form id="sendMail<?php echo $user['userId']; ?>"
                                                                            method="post" action="../controllers/sendGmail.php">
                                                                            <input type="hidden" name="user_id"
                                                                                value="<?php echo $user['userId']; ?>">
                                                                            <button
                                                                                formaction="../controllers/sendGmail.php?user_id=<?php echo $user['userId']; ?>"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" form="editAccountForm<?php echo $user['userId']; ?>"
